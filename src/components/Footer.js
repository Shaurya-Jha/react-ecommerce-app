            ...
            <div className="footer">
                <Container className="footer-container">
                    <Row>
                        ...
                        <Col sm={12} md={6} lg={3}>
                            <h6>Thank You</h6>
                            <p>Than you to the wonderful folks <br /> over at Herbivore for letting us use<br /> their beautiful imagery in this demo.</p>
                        </Col>

                        <Col sm={12} md={6} lg={3}>
                            <h6>Newsletter</h6>
                            <InputGroup>
                                <FormControl placeholder="you@gmail.com"></FormControl>
                                <Button variant="primary">SUBSCRIBE</Button>
                            </InputGroup>
                        </Col>
                    </Row>
                    <Row>
                        <p>Copyright &copy; 2020 Grid Bright.</p>
                        <p><b>Powered by Shopify</b></p>
                    </Row>
                </Container>
            </div>
        )
